        ...
        <html lang="en">
          <head>
            ...
            <link
              ...
              rel="stylesheet"
            />
            <title>Nueva creación de empleado</title>
            <style>
              body {
                font-family: Arial, sans-serif;;
                line-height: 1.5;
          ...
          <body>
            <div class="container">
              <div class="header">
                <h1>¡Se ha marcado como "CREADO" un empleado registrado!</h1>
              </div>
                ...
                <table width="100%">
                  <tr>
                    <td>
                      <p><strong>Cordial saludo,</strong></p>
                      <br/>
                      <p><strong>Se ha marcado como "CREADO" una solicitud de registro de empleado: ${body.razonSocial}, con número de identificación: ${body.rowId}</strong></p>
                      <br/>
                      <div class="warning">
                        <b>Para visualizar la información Ingresa aquí ${config.empleadoUrl}/${token}</b>                  
                      </div>
        ...
        <html lang="en">
          <head>
            ...
            <link
              ...
              rel="stylesheet"
            />
            <title>Nueva devolución de empleado</title>
            <style>
              body {
                font-family: Arial, sans-serif;;
                line-height: 1.5;
          ...
          <body>
            <div class="container">
              <div class="header">
                <h1>¡Se ha devuelto una solicitud de creación!</h1>
              </div>
                ...
                <table width="100%">
                  <tr>
                    <td>
                      <p><strong>Cordial saludo,</strong></p>
                      <br/>
                      <p><strong>Se ha devuelto una solicitud de registro de empleado: ${body.razonSocial}, con número de identificación: ${body.rowId}</strong></p>
                      <br/>
                      <p><strong>Razón de devolución:</strong> ${body.returnReason}</p>
                      <br/>
                      <div class="warning">
                        <b>Para visualizar la información Ingresa aquí ${config.empleadoUrl}/${token}</b>                  
                      </div>
