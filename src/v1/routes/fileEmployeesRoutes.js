...
router.post('/', upload.fields([
    ...
    if(folderName !== originalFolderName){
      ...
      const carpetaOrigen = `/GestionHumana/Empleados/${originalFolderName}`;
  
      // Ruta de la carpeta de destino
      const carpetaDestino = `/GestionHumana/Empleados/${folderName}`;
...
router.get('/archivo-empleado/:carpeta/:archivo', (req, res) => {
    ...
    const rutaArchivo = path.join('C:/GestionHumana/Empleados/', carpeta, archivo);
